...
plus your macOS version and how you installed AltTab. A screenshot usually says
more than a paragraph.

**Ideas.** Open an issue and describe the problem you are trying to solve, not
only the feature you have in mind. AltTab is deliberately small — a change that
...
mais a versao do macOS e como instalou o AltTab. Um print costuma dizer mais
que um paragrafo.

**Ideias.** Abra uma issue e descreva o problema que quer resolver, nao so a
funcionalidade que imaginou. O AltTab e pequeno de proposito — uma mudanca que
